...
def get_questions_for_schema() -> Dict[str, str]:
    ...
    """
    questions = {
        "directors_and_executives": "Who are the directors and key executives of the company?",
        "financial_performance": "What is the financial performance and key financial metrics?",
        "risk_factors": "What are the main risk factors and challenges facing the company?",
        "business_segments": "What are the main business segments and revenue sources?",
        "future_outlook": "What is the company's strategy and future outlook?",
        "governance_structure": "What is the corporate governance structure and policies?",
        "sustainability_initiatives": "What are the sustainability and CSR initiatives?",
        "market_position": "What is the company's market position and competitive landscape?",
        ...
        "dividend_policy": "What is the dividend policy and shareholder returns?",
        "capital_structure": "What is the capital structure and funding sources?",
        "technology_digital": "What technology and digital transformation initiatives are mentioned?",
        "human_resources": "What are the human resources policies and employee information?",
        "audit_internal_controls": "What audit findings and internal control measures are described?"
    }
