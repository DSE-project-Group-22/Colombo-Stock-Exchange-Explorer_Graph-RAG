...
// Query 3
MATCH (p:Person {name: 'S.D.R. Arudpragasam'}), (c:Company {name: 'THE FORTRESS RESORTS PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Chairman', r.as_of = date('2022-01-01');

// Query 4
MERGE (p:Person {name: 'R.C.A. Welikala'}) ON CREATE SET p.id = 'r_c_a_welikala';

// Query 5
MATCH (p:Person {name: 'R.C.A. Welikala'}), (c:Company {name: 'THE FORTRESS RESORTS PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2022-01-01');

// Query 6
MERGE (p:Person {name: 'R.N. Bopearatchy'}) ON CREATE SET p.id = 'r_n_bopearatchy';

// Query 7
MATCH (p:Person {name: 'R.N. Bopearatchy'}), (c:Company {name: 'THE FORTRESS RESORTS PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2022-01-01');
...
// Query 25
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Revenue'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 7764.0, r.year = 2024;

// Query 26
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Revenue'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 8199.0, r.year = 2023;

// Query 27
MERGE (m:Metric {name: 'Cash Inflow From Operations'}) ON CREATE SET m.id = 'cash_inflow_from_operations', m.unit = 'Rs. Mn';

// Query 28
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Cash Inflow From Operations'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 2655.0, r.year = 2024;

// Query 29
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Cash Inflow From Operations'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 3553.0, r.year = 2023;
...
// Query 32
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Net Profit Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 31.45, r.year = 2023;

// Query 33
MERGE (m:Metric {name: 'Taxes'}) ON CREATE SET m.id = 'taxes', m.unit = 'Rs. Mn';

// Query 34
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Taxes'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 491.0, r.year = 2024;

// Query 35
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Taxes'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 719.0, r.year = 2023;
...
// Query 38
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Return on Equity'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 41.81, r.year = 2023;
...
// Query 41
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Asset Turnover Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 0.90, r.year = 2023;
...
// Query 44
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Dividend Per Share'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 19.00, r.year = 2023;

// Query 45
MERGE (m:Metric {name: 'Debt: Equity Ratio'}) ON CREATE SET m.id = 'debt_equity_ratio', m.unit = '%';

// Query 46
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Debt: Equity Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 7.0, r.year = 2024;

// Query 47
MATCH (c:Company {name: 'THE FORTRESS RESORTS PLC'}), (m:Metric {name: 'Debt: Equity Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 5.0, r.year = 2023;

// Total queries: 47
// Generated on: 2025-09-03T13:44:16.700657
