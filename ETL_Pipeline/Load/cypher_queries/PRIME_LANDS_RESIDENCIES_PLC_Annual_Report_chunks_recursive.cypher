// Query 1
MERGE (c:Company {name: 'Prime Lands Residencies PLC'}) ON CREATE SET c.id = 'prime_lands_residencies_plc';
...
// Query 47
MATCH (p:Person {name: 'S.D.R. Arudpragasam'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Chairman', r.as_of = date('2025-03-31');

// Query 48
MATCH (p:Person {name: 'R.C.A. Welikala'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2025-03-31');

// Query 49
MATCH (p:Person {name: 'R.N. Bopearatchy'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2025-03-31');

// Query 50
MATCH (p:Person {name: 'E. T. De Zoysa'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Managing Director', r.as_of = date('2021-03-31');

// Query 51
MATCH (p:Person {name: 'R. S. A. Wickramasingha'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Chairman', r.as_of = date('2021-03-31');

// Query 52
MATCH (p:Person {name: 'D. S. Wickramasingha'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');

// Query 53
MATCH (p:Person {name: 'N. K. Wickramasingha'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');

// Query 54
MATCH (p:Person {name: 'L. J. M. De Silva'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');

// Query 55
MATCH (p:Person {name: 'M. U. S. G. Thilakawardana'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');

// Query 56
MATCH (p:Person {name: 'D. M. A. Kulasooriya'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');

// Query 57
MATCH (p:Person {name: 'M. S. Nanayakkara'}), (c:Company {name: 'Prime Lands Residencies PLC'}) MERGE (p)-[r:HOLDS_POSITION]->(c) ON CREATE SET r.title = 'Director', r.as_of = date('2021-03-31');
...
// Query 81
MATCH (c:Company {name: 'CDPLC'}), (m:Metric {name: 'Total Revenue'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 23695500000, r.year = 2024;
