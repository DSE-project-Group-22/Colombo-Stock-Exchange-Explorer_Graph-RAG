...
// Query 25
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Revenue'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 7764.0, r.year = 2024;

// Query 26
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Revenue'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 8199.0, r.year = 2023;

// Query 27
MERGE (m:Metric {name: 'Cash Inflow From Operations'}) ON CREATE SET m.id = 'cash_inflow_from_operations', m.unit = 'Rs. million';

// Query 28
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Cash Inflow From Operations'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 2655.0, r.year = 2024;

// Query 29
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Cash Inflow From Operations'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 3553.0, r.year = 2023;
...
// Query 34
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Taxes'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 491.0, r.year = 2024;

// Query 35
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Taxes'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 719.0, r.year = 2023;
...
// Query 46
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Debt: Equity Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 7.0, r.year = 2024;

// Query 47
MATCH (c:Company {name: 'VIDULLANKA PLC'}), (m:Metric {name: 'Debt: Equity Ratio'}) MERGE (c)-[r:HAS_METRIC]->(m) SET r.value = 5.0, r.year = 2023;

// Total queries: 47
// Generated on: 2025-09-03T13:22:40.085642
